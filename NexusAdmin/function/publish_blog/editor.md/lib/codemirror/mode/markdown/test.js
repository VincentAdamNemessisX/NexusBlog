...
(function() {
  ...
  function MT(name) { publish.mode(name, mode, Array.prototype.slice.call(arguments, 1)); }
  var modeHighlightFormatting = CodeMirror.getMode({tabSize: 4}, {name: "markdown", highlightFormatting: true});
  function FT(name) { publish.mode(name, modeHighlightFormatting, Array.prototype.slice.call(arguments, 1)); }
