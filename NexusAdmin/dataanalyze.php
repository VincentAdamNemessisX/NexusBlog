    ...
    <div class="layui-row layui-col-space15">
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-body" style="min-height: 280px;">
                    <div class="layui-col-sm12" id="main1" style="height: 300px;"></div>
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-body" style="min-height: 280px;">
                    <div class="layui-col-sm12" id="main2" style="height: 300px;"></div>
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-body" style="min-height: 280px;">
                    <div class="layui-col-sm12" id="main3" style="height: 300px;"></div>
        ...
        <div class="layui-col-sm12 layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-body" style="min-height: 280px;">
                    <div class="layui-col-sm12" id="main4" style="height: 300px;"></div>
