                ...
                <div class="container container--narrow">
                    <div class="block-heading block-heading_style-1 block-heading-no-line block-heading_style-1-small">
                        <h4 class="block-heading__title">
                            <span class="first-word">Page Title</span>
                        </h4>
                    </div>
                            ...
                            <div class="single-body entry-content typography-copy">
                                <div class="single-row">
                                        ...
                                        <div class="entry-meta">
                                            <div class="entry-author entry-author_style-1">
                                                ...
                                                <div class="entry-author__text">
                                                    <a class="entry-author__name" href="author.php"
                                                       rel="author" title="Posts by Connor Randall">Loren Ben</a>
                                                       ...
                                                       data-placement="top" href="#" title="Share on Facebook">
                                                        <div class="share-item__icon">
                                                            <svg fill="#888" height="1.3em"
                                                                 preserveaspectratio="xMidYMid meet" viewbox="0 0 40 40" width="1.3em">
                                                                <g>
                                    ...
                                    <div class="single-presentation">
                                        <p>Set to launch on the manufacturer’s new A330neo aircraft in 2017, it’s
                                            offering
                                            lots of extra space, including wider seats as standard, no control boxes
                                            under
                                            seats for the in-flight entertainment system, which means it’s all open for
                                            you
                                            ...
                                            <div class="entry-interaction entry-interaction--horizontal">
                                                <div class="entry-interaction__left">
                                                    <div class="entry-tags">
                                                        <ul>
                                                            <li><a class="post-tag" href="tags.php"
                                                    ...
                                                    <div class="entry-meta-count flex-box justify-content-end">
                                                        <a class="comments-count" data-original-title="13 Views" data-placement="top"
                                                           data-toggle="tooltip" href="#" title=""><i
                                                                class="mdicon mdicon-comment-o"></i> <span>4</span></a>
                                        ...
                                        <div class="author-box">
                                            ...
                                            <div class="author-box__text">
                                                <div class="author-name">
                                                    <a class="entry-author__name" href="author.php">Ryan Reynold</a>
                                                </div>
                                                ...
                                                <div class="posts-navigation__prev">
                                                    <article
                                                        ...
                                                        <div class="post__text text-right">
                                                            <a class="posts-navigation__label" href="single.php">
                                                                <svg height="6.545" viewbox="0 0 11.999 6.545"
                                                                     width="11.999" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="comments-area" id="comments">
                                    ...
                                    <div class="comment-body" id="div-comment-4">
                                        <footer class="comment-meta">
                                            ...
                                            <div class="comment-metadata">
                                                <a href="#">
                                                    <time datetime="2016-10-21T13:31:45+00:00">October 21, 2016 at 1:31
                                                        pm
                                                    </time>
                                                </a>
                                        ...
                                        <div class="comment-content">
                                            <p>There's good news, and there's bad news. The bad news is, it's not
                                                the drug. You're here, in the astral plane. You went too far in the
                                                make believe and got lost in your mind, consciousness, and now
                                                you're trapped in this, no place. Where every day is the same, where
                            ...
                            <div class="comment-respond" id="respond">
                                <h3 class="comment-reply-title" id="reply-title">Leave a Reply <small><a href="#"
                                    ...
                                    reply</a></small></h3>
                                <form action="#" class="comment-form" id="commentform" method="post" novalidate="">
                                    ...
                                    <p class="comment-form-comment">
                                        ...
                                        <textarea class="form-control-custom" cols="45" id="comment" maxlength="65525"
                                                  name="comment" placeholder="Your review" required="required"
                                                  rows="8"></textarea>
                                    </p>
                                    ...
                                    <p class="comment-form-email">
                                        ...
                                        <input aria-describedby="email-notes" class="form-control-custom" id="email" maxlength="100" name="email"
                                               placeholder="Email *" required="required" size="30"
                                               type="email" value="">
                                    </p>
                                    <p class="form-submit">
                                        <input class="submit" id="submit" name="submit" type="submit"
                                               value="Post Comment">
                                        <input id="comment_post_ID" name="comment_post_ID" type="hidden" value="44">
