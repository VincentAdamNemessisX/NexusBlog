            ...
            <div class="atbs-block atbs-block--fullwidth atbs-single-header background-dots">
                <div class="single-header__inner container">
                    ...
                    <header class="single-header inverse-text">
                        <a class="entry-cat post__cat" href="categorystyle-1.php">INSPIRATION</a>
                                    ...
                                    <div class="comment-respond" id="respond">
                                        ...
                                        <form action="#" class="comment-form" id="commentform" method="post"
                                            ...
                                            <p class="comment-form-author">
                                                ...
                                                <input class="form-control-custom" id="author" maxlength="245"
                                                       name="author"
                                            ...
                                            <p class="comment-form-email">
                                                ...
                                                <input aria-describedby="email-notes" class="form-control-custom"
