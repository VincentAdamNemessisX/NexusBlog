            ...
            <div class="container">
                <div class="row">
                    <div class="atbs-main-col">
                        <div class="atbs-block atbs-block--fullwidth single-entry-wrap module-typography">
                            <article class="post post--single">
                                <div class="single-content">
                                    <div class="single-body entry-content typography-copy">
                                        <div class="entry-content typography-copy">
                                            ...
                                            <table>
                                                ...
                                                <tr class="odd">
                                                    <td><a href="javascript:;">John Saddington</a></td>
                                                    <td>$1</td>
                                                    <td>Because that’s all Steve Job’ needed for a salary.</td>
                                                </tr>
                                                <tr class="even">
                                                    <td><a href="javascript:;">Tom McFarlin</a></td>
                                                    <td>$100K</td>
                                                    <td>For all the blogging he does.</td>
                                                </tr>
                                                <tr class="odd">
                                                    <td><a href="javascript:;">Jared Erickson</a></td>
                                                    <td>$100M</td>
                                                    <td>Pictures are worth a thousand words, right? So Tom x 1,000.</td>
                                                </tr>
                                                <tr class="even">
                                                    <td><a href="javascript:;">Chris Ames</a></td>
                                                    <td>$100B</td>
                                            ...
                                            <dl>
                                                ...
                                                <dt>Do It Live</dt>
                                                <dd>I’ll let Bill O’Reilly will <a href="javascript:;"
                                                                                   title="We'll Do It Live">explain</a>
                                                    this one.
                                                </dd>
                                            </dl>
                                            ...
                                            <p>This is an example of a <a href="javascript:;" title="Apple">link</a>.
                                            </p>
                                            <p><strong>Abbreviation Tag</strong></p>
                                            <p>The abbreviation <abbr title="Seriously">srsly</abbr> stands for
                                                “seriously”.</p>
                                            ...
                                            <p>This tag will let you
                                                ...
                                                , but this tag is no longer supported in HTML5 (use the <code>&lt;strike&gt;</code>
                                                instead).
                                            </p>
                                            ...
                                            <p>This scarsly known tag emulates <kbd>keyboard text</kbd>, which is
                                                usually styled like the <code>&lt;code&gt;</code> tag.</p>
                                    ...
                                    line-height: 1.2;
                                            ...
                                            <p>Still sticking with science and Albert Einstein’s&nbsp;E = MC<sup>2</sup>,
                                                which should lift the “2” up.</p>
