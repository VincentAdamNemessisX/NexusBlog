                        ...
                        <div class="section-main__inner flex-box flex-space-30">
                            <div class="post-main">
                                <article
                                    ...
                                    <a class="post__cat post__cat--bg overlay-item--top-left" href="">GADGETS</a>
                                </article>
                            </div>
                            <div class="post-sub">
                                <article
                                    ...
                                    <div class="post__text flex-box flex-direction-column inverse-text">
                                        <div class="post__text-group">
                                            <a class="post__cat post__cat-primary" href="">GADGETS</a>
                                        ...
                                        <div class="list-item">
                                            <article class="post post--vertical post--vertical-rectangle-outside">
                                                <div class="post__thumb object-fit">
                                                    ...
                                                    <a class="post__cat post__cat--bg" href="">GADGETS</a>
                                                </div>
